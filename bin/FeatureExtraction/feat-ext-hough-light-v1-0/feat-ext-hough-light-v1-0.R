...
MethodName<-"feat-ext-hough-light-v1-0"
...
#FGpath <- "C:/instinct_dt/Cache/759d301bd84ae67b43ef9ba4d2932e4be46cbbcc/" #docker volume
#DETpath <- "C:/instinct_dt/Cache/759d301bd84ae67b43ef9ba4d2932e4be46cbbcc/a7de29f85dd4ab2fc9c4a057cc24377f9a6017e2" #docker volume
#resultPath<-"C:/instinct_dt/Cache/759d301bd84ae67b43ef9ba4d2932e4be46cbbcc/a7de29f85dd4ab2fc9c4a057cc24377f9a6017e2/29e61f5b67167080e9ba47649f126a03647c4967"
  ...
  out1<-foreach(r=1:nrow(dataIn)) %do% {
    ...
    if(StartNameL!=dataIn$StartFile[r]){
      if(dataIn$StartFile[r]==EndNameL){
        ...
        StartFileL<-readWave(paste(DataPath,FG$FullPath[which(FG$FileName==StartNameL)],StartNameL,sep=""))
      }
    }
    if(EndNameL!=dataIn$EndFile[r]){
      if(dataIn$EndFile[r]==StartNameL){
        ...
        EndFileL<-readWave(paste(DataPath,FG$FullPath[which(FG$FileName==EndNameL)],EndNameL,sep=""))
      }
    }
