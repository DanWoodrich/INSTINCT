...
#v-4: 
#save spectrograms to special folder
...
FeatureExtracteR<-function(wav=NULL,spectrogram=NULL,featList=NULL,args=NULL,verbose=NULL,metadata=NULL){
    ...
    if(verbose=='y'&sample(1:100,1)==1){
      ...
      endpath2<-paste(endpath1,"/FE/",sep="")
      ...
      jpeg(paste(endpath3,"/",metadata[1][[1]],"_",round(featList[1]),"_spectrogram.jpg",sep=""),quality=100)
      ...
      jpeg(paste(endpath3,"/",metadata[1][[1]],"_",round(featList[1]),"_img.jpg",sep=""),quality=100)
